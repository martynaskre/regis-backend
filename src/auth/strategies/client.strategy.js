...
var ClientStrategy = /** @class */ (function (_super) {
    ...
    function ClientStrategy(configService, clientRepository) {
        ...
        _this.clientRepository = clientRepository;
        return _this;
    }
    ClientStrategy.prototype.validate = function (payload) {
...
}((0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, 'client')));

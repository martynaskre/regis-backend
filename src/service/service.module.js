...
var ServiceModule = /** @class */ (function () {
    ...
    ServiceModule = __decorate([
        (0, common_1.Module)({
            imports: [typeorm_1.TypeOrmModule.forFeature([service_entity_1.Service, business_entity_1.Business])],
            controllers: [service_controller_1.ServiceController],
            providers: [service_service_1.ServiceService, business_service_1.BusinessService]
        })
    ], ServiceModule);

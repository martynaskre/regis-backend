...
var ValidationPipe = /** @class */ (function () {
    ...
    ValidationPipe.prototype.transform = function (body, metadata) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        object = (0, class_transformer_1.plainToClass)(metatype, body);
                        return [4 /*yield*/, (0, class_validator_1.validate)(object)];
                    case 1:
                        errors = _a.sent();
                        if (errors.length > 0) {
                            (0, utils_1.throwValidationException)(this.buildErrors(errors));
                        }
                        return [2 /*return*/, body];
                }
            });
    ...
    ValidationPipe.prototype.buildErrors = function (errors) {
        var result = {};
